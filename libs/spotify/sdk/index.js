          ...
          return (
            ...
            (f.prototype.connect = function () {
              return this.isLoaded.then(
                function () {
                    console.log("PROUT CONNECT INSIDE")
                  var e = this._sendMessage(o.connect());

                  console.log("alrseij", s.defer().promise)

                //   setInterval(() => console.log("xwesh", this._connectionRequests[e].promise), 1000)
                  return (
            ...
            (f.prototype._onGetToken = function (e, t) {
              ...
              console.log("ONGE TOKTEOKN la force du freui")
              new s(n).then(
                function (e) {
