...
export class Calibre extends Compose {
  ...
  protected readonly volumes = {
    'readarr-config': new Volume(this, 'readarr-config'),
  };
  ...
  @AutoUpdate()
  protected readonly calibre = new Service(this, 'calibre', {
    ...
    volumes: ['/mnt/raid/0.SHARED/3.Books/:/config'],
  });
  ...
  constructor(
    ...
    // this.web.webAccess(this.calibre, {
    //   routerName: 'calibre-web-legacy',
    //   match: 'Host(`calibre-web.davidfain.com`)',
    //   port: 8081,
    // });
